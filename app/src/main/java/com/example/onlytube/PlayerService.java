...
public class PlayerService extends Service implements View.OnClickListener {
    ...
    /////-----------------*****************----------------onStartCommand---------------*****************-----------
    private void doThis(final Intent intent) {
        ...
        download  = (ImageView)playerView.findViewById(R.id.download);
       ...
       /* repeatTypeImg.setOnClickListener(new View.OnClickListener() {
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String down = link+VID_ID;
                //   Toast.makeText(mContext, "vidoid"+down, Toast.LENGTH_SHORT).show();
                //Intent inte = new Intent(PlayerService.this,MyDownloadActivity.class);
