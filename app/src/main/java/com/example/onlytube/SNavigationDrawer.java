...
public class SNavigationDrawer extends RelativeLayout {
    ...
    private int appbarColor = R.color.colorWhite;
    private int appbarTitleTextColor = R.color.colorBlack;
    private int menuItemSemiTransparentColor = R.color.transparent_black_percent_60;
    private int navigationDrawerBackgroundColor = R.color.colorWhite;
    private int primaryMenuItemTextColor = R.color.colorWhite;
    private int secondaryMenuItemTextColor = R.color.colorBlack;
    private int menuIconTintColor = R.color.colorBlack;
