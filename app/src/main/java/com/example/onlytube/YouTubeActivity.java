...
public class YouTubeActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
            ...
            youtubeView.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    if (url.contains("?app=desktop") && !url.contains("signin?app=desktop")) {
                        ...
                        TextView tv = snkBar.findViewById(R.id.snackbar_text);
                        //  TextView tv = snkBar.findViewById(android.support.v4.R.id.snackbar_text);
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (isServiceRunning(PlayerService.class)) {
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(YouTubeActivity.this)) {
                                            Intent i = new Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
                                                    Uri.parse("package:" + getPackageName()));
                                            startActivityForResult(i, OVERLAY_PERMISSION_REQ);
                                        } else {
                                            Intent i = new Intent(YouTubeActivity.this, PlayerService.class);
    ...
    private boolean isInternetAvailable(Activity context) {
            ...
            public void onChanged(@Nullable String s) {
                if (s != null) {
                    ...
                    if (res.length > 0) {
                        ...
                        SuggestionCursorAdapter cursorAdapter = new SuggestionCursorAdapter(YouTubeActivity.this,
                                cursor, false,searchView);
